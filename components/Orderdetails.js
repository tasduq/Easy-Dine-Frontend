  ...
  return (
    <div>
      ...
      <button className="btn btn-success" onClick={handleClickOpen}>
        <i className="fas fa-sign-in-alt"></i> View Order Details
      </button>
      <Dialog
        fullScreen
        open={open}
        ...
        >
          <Toolbar>
            ...
            <Typography sx={{ ml: 2, flex: 1 }} variant="h6" component="div">
              Bucket <i className="fas fa-shopping-basket"></i>
            </Typography>
        ...
        <div>
          <div className="container mt-5">
            <h2 className="text-center">
              your Order Bucket <span className="text-danger">.</span>
            </h2>
            <br />
            ...
            {data?.length > 0 &&
              data.map((item) => {
                return (
                  <div key={item._id} className="row my-4">
                    {console.log(item)}
